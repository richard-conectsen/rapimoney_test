...
<body class="has-navbar-fixed-top">
        ...
        <div class="container">
          <div class="card-content">
            ...
            <div class="content">
              ...
              <p class="benefit-rapimoney is-size-5-mobile is-size-4-tablet is-size-2-desktop">
                Obten un
                <span class="has-text-weight-bold">descuento de hasta 4%</span>
                pagando tu recibo de Luz con <span class="has-text-weight-bold"> </span>
                nosotros.
            ...
            <div class="content-post-img">
              <div class="content-image-post-pagos">
                <img class="image-post"
                  src="<?php echo base_url('/assets/img/page-payments/post-pago-servicios.png'); ?>"
                  alt="post-rapimoney">
              </div>
            </div>
          </div>
          ...
          <div class="media-content">
            ...
            <div class="content">
              ...
              <p
                ...
                <span> VALOR DEL</span>
                <span class="msg-retiro">RECIBO DE PAGO</span>
              </p>
              ...
              <div class="content-monto">
                <label class="lbl-monto">
                  <input class="input input-monto has-text-centered" type="text" id="receipt-amount"
            ...
            <div class="content-comision card-content">
              ...
              <div class="content">
                ...
                <div class="control">
                  <p class="has-text-centered has-text-white">Descuento RAPIMONEY</p>
                  <div class="content-input-comision">
                    <label class="lbl-input">
                      <input class="input input-comision has-text-centered" type="text" id="rapimoney-discount"
              ...
              <div class="content">
                <div class="control">
                  <p class="has-text-centered has-text-white">Solo PAGAS</p>
                  <div class="content-input-comision">
                    <label class="lbl-input">
                      <input class="input input-comision has-text-centered" type="text" id="client-pays"
                        placeholder="S/ 0.00" readonly>
                    </label>
                  </div>
                </div>
            ...
            <div class="card-content">
              <div class="control">
                <div class="content-btn-calculate">
                  ...
                  <a href="https://forms.gle/fChNc3SRwaBuHwck9" target="_blank">
        ...
        <div class="funciona-desktop">
          <div class="content-img-funciona-desktop">
            <img class="img-funciona-desktop"
              src="<?php echo base_url('/assets/img/page-payments/proceso-pago-servicios.png') ?>"
        ...
        <div class="slider-funciona-rapimoney">
          ...
          <div class="content-title">
            <p class="my-title has-text-centered has-text-weight-bold is-size-6-mobile is-size-5-tablet">
              PROCESO DE PAGO CON
              <span class="msg-title">DESCUENTO</span>
            </p>
          </div>
              ...
              <div class="carousel__lista">
                ...
                <div class="carousel__elemento">
                  <img class="carousel__image "
                    src="<?php echo base_url('/assets/img/page-payments/registra-recibo.png') ?>"
                    alt="registra tu recibo">
                </div>

                <div class="carousel__elemento">
                  <img class="carousel__image "
                    src="<?php echo base_url('/assets/img/page-payments/deposito-recibo.png') ?>"
                    alt="realiza el deposito de tu recibo">
                </div>

                <div class="carousel__elemento">
                  <img class="carousel__image"
                    src="<?php echo base_url('/assets/img/page-payments/comprobante-recibo.png') ?>"
                    alt="recide tu comprobante de tu recibo">
                </div>
              </div>
          ...
          <div class="item-operaciones">
            <div class="content-img-operaciones">
              <img class="img-operaciones"
                src="<?php echo base_url('/assets/img/page-payments/operacion-pogo-descuento.png') ?>"
    ...
    <section>
      ...
      <article>
        ...
        <div class="content-redes">
          ...
          <a href="http://shorturl.at/fjrtO" target="_blank">
  ...
  <script src="<?php echo base_url('/assets/js/calculadora-pago-servicios.js') ?>"></script>
  <script src="<?php echo base_url('/assets/js/modal-video-pago.js') ?>"></script>
