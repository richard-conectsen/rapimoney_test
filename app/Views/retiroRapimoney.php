...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('/assets/style/components-css/tarjetas.css') ?>">
...
<body class="has-navbar-fixed-top">
  ...
  <main>
        ...
        <div class="container">
          <div class="card-content">
            ...
            <div class="content">
              ...
              <p class="benefit-rapimoney is-size-5-mobile is-size-4-tablet is-size-2-desktop">La manera más <span
                  class="has-text-weight-bold">rápida</span>
                y
                <span class="has-text-weight-bold">segura</span> de retirar
                efectivo con tu tarjeta de crédito.
              </p>

            </div>

            <div class="content-post-img">
              <div class="content-image-post-retiro">
                <img class="image-post" src="<?php echo base_url('/assets/img/main/img-retiro-efectivo.png'); ?>"
                  alt="post-rapimoney">
              </div>
            </div>
          </div>
          ...
          <div class="media-content">
            ...
            <div class="content">
              ...
              <p
                ...
                <span class="msg-retiro">DE TU TARJETA</span>
              </p>
              ...
              <div class="content-monto">
                <label class="lbl-monto">
                  <input class="input input-monto has-text-centered" type="text" id="monto-rapi" placeholder="S/ 0.00"
                    maxlength="10">
                </label>
              </div>
            ...
            <div class="content-comision card-content">
              ...
              <div class="content">
                ...
                <div class="control">
                  <p class="has-text-centered has-text-white">Comisión RAPIMONEY</p>
                  <div class="content-input-comision">
                    <label class="lbl-input">
                      <input class="input input-comision has-text-centered" type="text" id="monto-comision"
              ...
              <div class="content">
                <div class="control">
                  <p class="has-text-centered has-text-white">Te transferimos</p>
                  <div class="content-input-comision">
                    <label class="lbl-input">
                      <input class="input input-comision has-text-centered" type="text" id="monto-trans"
                        placeholder="S/ 0.00" readonly>
                    </label>
                  </div>
                </div>
            ...
            <div class="card-content">
              <div class="control">
                <div class="content-btn-calculate">
                  ...
                  <a href="https://forms.gle/nyRNR4Ndt117iRxW8" target="_blank">
    ...
    <section class="content-sponsor-video">
      ...
      <!-- RAPIMONEY CARDS -->
      <article>
        <div class="content-patrocinadores content-patrocinadores--tarjetas">

          <div class="item-patrocinador-tarjeta item-patrocinador-tarjeta__size">
      ...
      <article class="content-funciones-rapimoney">
        ...
        <div class="funciona-desktop">
          <div class="content-img-funciona-desktop">
            <img class="img-funciona-desktop" src="<?php echo base_url('/assets/img/main/proceso-retiro.png') ?>"
        ...
        <div class="slider-funciona-rapimoney">
          ...
          <div class="content-title">
            <p class="my-title has-text-centered has-text-weight-bold is-size-6-mobile is-size-5-tablet">
              PROCESO DE RETIRO CON
              <span class="msg-title">TARJETA DE CRÉDITO</span>
            </p>
          </div>
            ...
            <div class="carousel__contenedor">
              ...
              <div class="carousel__lista">
                ...
                <div class="carousel__elemento">
                  <img class="carousel__image " src="<?php echo base_url('/assets/img/main/cotiza.png') ?>"
                    alt="cotiza tu operación">
                </div>

                <div class="carousel__elemento">
                  <img class="carousel__image " src="<?php echo base_url('/assets/img/main/envia.png') ?>"
                    alt="envia el comprobante de pago">
                </div>

                <div class="carousel__elemento">
                  <img class="carousel__image" src="<?php echo base_url('/assets/img/main/recibe.png') ?>"
                    alt="recide tu dinero">
                </div>
              </div>
        ...
        <div class="content-img-monto-operaciones py-5 my-5">
          ...
          <div class="item-operaciones">
            <div class="content-img-operaciones">
              <img class="img-operaciones" src="<?php echo base_url('/assets/img/main/operacion-retiro.png') ?>"
              ...
              <div class="card-content">
                <div class="content">
                  <p class="has-text-centered has-text-white is-size-6-mobile is-size-5-tablet is-size-4-desktop">
                    <span class="monto-operaciones">+ S/ 25 000.00</span>
                    retiros realizados
                  </p>
    ...
    <section>
      ...
      <article>
        ...
        <div class="content-redes">
          ...
          <a href="http://shorturl.at/muKN8" target="_blank">
  ...
  <script src="<?php echo base_url('/assets/js/calculadora-retiro-efectivo.js') ?>"></script>
  <script src="<?php echo base_url('/assets/js/modal-video-retiro.js') ?>"></script>
